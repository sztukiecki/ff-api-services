...
export class EmailController extends APIClient {
     ...
     * @param excludedItems
     */
    async sendEmail(email: Omit<EmailData, 'from'>, dateRange: DateRange, activityId: string, templateId: string, entity: EntityIdData, excludedItems: ExcludedItem[]) {
    ...
    async preview(email: Omit<EmailData, 'from'>, dateRange: DateRange, activityId: string, templateId: string, entity: EntityIdData, excludedItems: ExcludedItem[]) {
        const body = {
            email,
            dateRange,
            activityId,
