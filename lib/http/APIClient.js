...
var aws_sdk_1 = require("@flowfact/aws-sdk");
...
var APIClient = /** @class */ (function () {
    function APIClient(config) {
        ...
        this.getidToken = function () {
            if (aws_sdk_1.default.Config.credentials && aws_sdk_1.default.Config.credentials.params && aws_sdk_1.default.Config.credentials.params.Logins) {
                var loginKeys = Object.keys(aws_sdk_1.default.Config.credentials.params.Logins);
                if (loginKeys.length > 0) {
                    _this.idToken = aws_sdk_1.default.Config.credentials.params.Logins[loginKeys[0]];
                }
            }
