...
var getStageFromStore = function () {
    'use strict';
    var fromStore = store_1.default.get(StoreKeys.EdgeServiceStage);
    return fromStore ? fromStore : defaultStage;
};
exports.getStageFromStore = getStageFromStore;
var getVersionTagFromStore = function () {
    'use strict';
    var fromStore = store_1.default.get(StoreKeys.EdgeServiceVersionTag);
...
var setStageInStore = function (stage) {
    'use strict';
    if (stage) {
        store_1.default.set(StoreKeys.EdgeServiceStage, stage);
    }
};
...
var setVersionTagInStore = function (versionTag) {
    'use strict';
    if (versionTag) {
        store_1.default.set(StoreKeys.EdgeServiceVersionTag, versionTag);
    }
};
