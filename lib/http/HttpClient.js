...
var HttpClient = function () {
    function HttpClient(apiMapping) {
        ...
        this.setAPIURL = function () {
            if (_this.apiClient) {
                _this.apiClient.config.url = document.location.protocol + '//cloudios-1932238678.eu-central-1.elb.amazonaws.com/edge-service/' + _this.serviceName + '/' + _this.stageToUse;
            }
        };
