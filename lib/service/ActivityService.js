...
var ActivityService = (_temp = _class = function () {
    ...
    _createClass(ActivityService, null, [{
        ...
        value: function searchActivities(search) {
            ...
            return this.client.makeRequestSimple(searchQuery, '/activities/search', 'POST').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function getActivityById(id) {
            return this.client.makeRequestSimple({}, '/activities/' + id, 'GET').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function createActivity(body) {
            return this.client.makeRequestSimple(body, '/activities', 'POST').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function updateActivity(body) {
            return this.client.makeRequestSimple(body, '/activities/' + body.id, 'PUT').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function deleteActivity(id) {
            return this.client.makeRequestSimple({}, '/activities/' + id, 'DELETE').then(function (s) {
                return s.data;
            });
        }
    }]);
