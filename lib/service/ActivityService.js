...
var ActivityService = (_temp = _class = function () {
    function ActivityService() {
        _classCallCheck(this, ActivityService);
    }

    _createClass(ActivityService, null, [{
        ...
        value: function getAllActivities() {
            ...
            return ActivityService.client.makeRequest(searchQuery, '/activities', 'GET').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function getActiveActivities() {
            ...
            return ActivityService.client.makeRequest(searchQuery, '/activities/active', 'GET').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function searchActivities(search) {
            ...
            return ActivityService.client.makeRequestSimple(searchQuery, '/activities/search', 'POST').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function getActivityById(id) {
            return ActivityService.client.makeRequestSimple({}, '/activities/' + id, 'GET').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function createActivity(body) {
            return ActivityService.client.makeRequestSimple(body, '/activities', 'POST').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function updateActivity(body) {
            return ActivityService.client.makeRequestSimple(body, '/activities/' + body.id, 'PUT').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function deleteActivity(id) {
            return ActivityService.client.makeRequestSimple({}, '/activities/' + id, 'DELETE').then(function (s) {
                return s.data;
            });
        }
    }]);
...
}(), _class.client = new HttpClient(APIMapping.activityService), _temp);
