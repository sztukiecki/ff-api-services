...
var ActivityService = (_temp = _class = function () {
    ...
    _createClass(ActivityService, null, [{
        ...
        value: function searchActivities(search) {
            ...
            return ActivityService.client.makeRequetSimple(searchQuery, '/activities/search', 'POST').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function getActivityById(id) {
            return ActivityService.client.makeRequetSimple({}, '/activities/' + id, 'GET').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function createActivity(body) {
            return ActivityService.client.makeRequetSimple(body, '/activities', 'POST').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function updateActivity(body) {
            return ActivityService.client.makeRequetSimple(body, '/activities/' + body.id, 'PUT').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function deleteActivity(id) {
            return ActivityService.client.makeRequetSimple({}, '/activities/' + id, 'DELETE').then(function (s) {
                return s.data;
            });
        }
    }]);
