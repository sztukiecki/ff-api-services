...
var ActivityService = (function () {
    ...
    ActivityService.getAllActivities = function (page, size) {
        ...
        return ActivityService.client.makeRequest(searchQuery, '/activities', 'GET').then(function (s) { return s.data; });
    };
    ActivityService.getActiveActivities = function (page, size) {
        ...
        return ActivityService.client.makeRequest(searchQuery, '/activities/active', 'GET').then(function (s) { return s.data; });
    };
