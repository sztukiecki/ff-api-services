...
var FunnelService = (_temp = _class = function () {
    ...
    _createClass(FunnelService, null, [{
        ...
        value: function getPossibleTags(funnelId) {
            return FunnelService.client.makeRequetSimple({}, '/funnels/' + funnelId + '/possibletags', 'GET').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function getFunnelStatistics(funnelId) {
            return FunnelService.client.makeRequetSimple({}, '/funnels/' + funnelId + '/statistics', 'GET').then(function (s) {
                return s.data;
            });
        }
        /**
        ...
        value: function createFunnel(funnelToCreate) {
            return FunnelService.client.makeRequetSimple(funnelToCreate || {}, '/funnels', 'POST').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function findFunnelById(funnelId) {
            return FunnelService.client.makeRequetSimple({}, '/funnels/' + funnelId, 'GET').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function deleteFunnelById(funnelId) {
            return FunnelService.client.makeRequetSimple({}, '/funnels/' + funnelId, 'DELETE').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function getAllStagesOfAnFunnel(funnelId) {
            return FunnelService.client.makeRequetSimple({}, '/funnels/' + funnelId + '/stages', 'GET').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function addStageAtTheEndOfTheFunnel(funnelId, stage) {
            return FunnelService.client.makeRequetSimple(stage || {}, '/funnels/' + funnelId + '/stages', 'POST').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function findStageById(funnelId, stageId) {
            return FunnelService.client.makeRequetSimple({}, '/funnels/' + funnelId + '/stages/' + stageId, 'GET').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function addStageAfterGivenStageOfGivenFunnel(funnelId, stageId, stage) {
            return FunnelService.client.makeRequetSimple(stage, '/funnels/' + funnelId + '/stages/' + stageId, 'POST').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function changeAStagesOfAFunnel(funnelId, stageId, stage) {
            return FunnelService.client.makeRequetSimple(stage, '/funnels/' + funnelId + '/stages/' + stageId, 'PUT').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function deleteStageFromFunnel(funnelId, stageId) {
            return FunnelService.client.makeRequetSimple({}, '/funnels/' + funnelId + '/stages/' + stageId, 'DELETE').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function getStateOfTheFunnel(funnelId) {
            return FunnelService.client.makeRequetSimple({}, '/funnels/' + funnelId + '/state', 'GET').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function changeStateOfTheFunnel(funnelId, state) {
            return FunnelService.client.makeRequetSimple(state || {}, '/funnels/' + funnelId + '/state', 'POST').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function getAllActions() {
            ...
            return FunnelService.client.makeRequetSimple({}, '/funnels/actions/?type=' + type, 'GET').then(function (s) {
                return s.data;
            });
        }
        /*
        ...
        value: function getDashboardInformation(state) {
            ...
            return FunnelService.client.makeRequetSimple({}, '/funnels/dashboard', 'GET').then(function (s) {
                return s.data.dashboardFunnels;
            });
        }
        ...
        value: function getAvailableEntryConditionsForSchema(schemaId) {
            return FunnelService.client.makeRequetSimple({}, '/availableEntryConditions/' + schemaId, 'GET').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function getAvailableEntryConditionsForPrevStage(funnelId, stageId) {
            return FunnelService.client.makeRequetSimple({}, '/funnels/' + funnelId + '/stages/' + stageId + '/availableEntryConditions', 'GET').then(function (s) {
                return s.data;
            });
        }
