...
var FunnelService = (_temp = _class = function () {
    ...
    _createClass(FunnelService, null, [{
        ...
        value: function getPossibleTags(funnelId) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId + '/possibletags', 'GET').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function getKeysForTag(funnelId, tagName) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId + '/tags/' + tagName + '/metadata/keys', 'GET').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function getValuesForTagKey(funnelId, tagName, metadataKey) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId + '/tags/' + tagName + '/metadata/keys/' + metadataKey + '/values', 'GET').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function getFunnelStatistics(funnelId) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId + '/statistics', 'GET').then(function (s) {
                return s.data;
            });
        }
        /**
        ...
        value: function createFunnel(funnelToCreate) {
            return this.client.makeRequestSimple(funnelToCreate || {}, '/funnels', 'POST').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function findFunnelById(funnelId) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId, 'GET').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function deleteFunnelById(funnelId) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId, 'DELETE').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function getAllStagesOfAnFunnel(funnelId) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId + '/stages', 'GET').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function addStageAtTheEndOfTheFunnel(funnelId, stage) {
            return this.client.makeRequestSimple(stage || {}, '/funnels/' + funnelId + '/stages', 'POST').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function findStageById(funnelId, stageId) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId + '/stages/' + stageId, 'GET').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function addStageAfterGivenStageOfGivenFunnel(funnelId, stageId, stage) {
            return this.client.makeRequestSimple(stage, '/funnels/' + funnelId + '/stages/' + stageId, 'POST').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function changeAStagesOfAFunnel(funnelId, stageId, stage) {
            return this.client.makeRequestSimple(stage, '/funnels/' + funnelId + '/stages/' + stageId, 'PUT').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function deleteStageFromFunnel(funnelId, stageId) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId + '/stages/' + stageId, 'DELETE').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function getStateOfTheFunnel(funnelId) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId + '/state', 'GET').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function changeStateOfTheFunnel(funnelId, state) {
            return this.client.makeRequestSimple(state || {}, '/funnels/' + funnelId + '/state', 'POST').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function getAllActions() {
            ...
            return this.client.makeRequestSimple({}, '/funnels/actions/?type=' + type, 'GET').then(function (s) {
                return s.data;
            });
        }
        /*
        ...
        value: function getDashboardInformation(state) {
            ...
            return this.client.makeRequestSimple({}, '/funnels/dashboard', 'GET').then(function (s) {
                return s.data.dashboardFunnels;
            });
        }
        ...
        value: function getAvailableEntryConditionsForSchema(schemaId) {
            return this.client.makeRequestSimple({}, '/availableEntryConditions/' + schemaId, 'GET').then(function (s) {
                return s.data;
            });
        }
        ...
        value: function getAvailableEntryConditionsForPrevStage(funnelId, stageId) {
            return this.client.makeRequestSimple({}, '/funnels/' + funnelId + '/stages/' + stageId + '/availableEntryConditions', 'GET').then(function (s) {
                return s.data;
            });
        }
