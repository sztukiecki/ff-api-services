...
var FunnelService = function () {
    ...
    _createClass(FunnelService, [{
        ...
        value: function getPossibleTags(funnelId) {
            return this.client.makeRequetSimple({}, '/funnels/' + funnelId + '/possibletags', 'GET').then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function getAllActions() {
            ...
            return this.client.makeRequetSimple({}, '/funnels/actions/?type=' + type, 'GET').then(function (s) {
                return s.data;
            });
        }
        /*
