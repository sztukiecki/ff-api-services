...
var WordpressTemplateService = (_temp = _class = function () {
    ...
    _createClass(WordpressTemplateService, null, [{
        ...
        key: 'linkTemplateToSite',
        value: function linkTemplateToSite(pageId, templateId) {
            return WordpressTemplateService.wordpressApi.template().param('userid', this.cognitoId).create({
