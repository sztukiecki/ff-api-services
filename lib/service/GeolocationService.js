...
var GeolocationService = (_temp = _class = function () {
    ...
    _createClass(GeolocationService, null, [{
        ...
        value: function getAutocompletionResults(query, cancelToken) {
            ...
            return this.client.makeRequest({}, '/search', 'GET', undefined, additionalParams).then(function (s) {
                return s.data;
            });
        }
    }, {
        ...
        value: function getBestMatchCoordinates(query) {
            ...
            return this.client.makeRequest({}, '/getBestMatchCoordinates', 'GET', undefined, additionalParams).then(function (s) {
                return s.data;
            });
        }
    }]);
