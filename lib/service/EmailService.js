...
var EmailService = (_temp = _class = function () {
    ...
    _createClass(EmailService, null, [{
        ...
        value: function createDomain(domain) {
            return EmailService.client.makeRequestSimple({ domain: domain }, '/configuration/whitelabel', 'POST').then(function (_ref) {
                var data = _ref.data;
                return data;
            });
        }
        ...
        value: function verifyDomain(domain) {
            return EmailService.client.makeRequestSimple({ domain: domain }, '/configuration/whitelabel/verify', 'POST').then(function (_ref2) {
                var data = _ref2.data;
                return data;
            });
        }
