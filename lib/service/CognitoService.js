...
var CognitoService = function () {
    function CognitoService() {
        ...
        this.setNewLoginData = function (idToken) {
        ...
        AWS.Config.setConfig(region, settings['development'].identityPoolId, settings['development'].userPoolId, settings['development'].clientId);
    }
