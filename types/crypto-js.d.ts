...
// yes, string... this seems to work... somehow...
type AnyTypedArray = ArrayBuffer | Int8Array | Uint8Array | Int16Array | Uint16Array | Int32Array | Uint32Array | Float32Array | Float64Array | string;
...
declare namespace CryptoJS {
    module lib {
        ...
        interface WordArray extends Base {
            ...
            init(typedArray: AnyTypedArray): void
            create(typedArray: AnyTypedArray): WordArray
        ...
        interface IHasherHelper<C> {
            (message: WordArray|string, cfg?: C): WordArray
        }
    ...
    module algo {
        ...
        interface PBKDF2 extends EvpKDF {
